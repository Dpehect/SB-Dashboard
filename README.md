...
*   **Styling:** Tailwind CSS 4 (Native/Performance optimized)
*   **Animations:** Framer Motion (Spring dynamics & Layout transitions)
*   **Form Management:** React Hook Form & Zod Validation
*   **Backend Integration:** Server Actions & Node.js SMTP
*   **State Management:** React Context & Hooks (useState, useEffect, useRef)
*   **Design Language:** Visionary UI (Integrated Apple & Stripe design systems)
